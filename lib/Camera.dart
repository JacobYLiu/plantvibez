...
class TakePictureScreenState extends State<CameraScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Take pics!'),backgroundColor: Colors.lightGreen,),
...
class DisplayPictureScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Display the Picture'), backgroundColor: Colors.lightGreen,),
      // The image is stored as a file on the device. Use the `Image.file`
      // constructor with the given path to display the image
      body: Image.file(File(imagePath)),
      bottomNavigationBar: Text(imagePath.toString()),
    );
  }
}